  ...
  public function getPanelContent ()
  {
    ...
    if ($user->canSimulateProfile ())
    {
      ...
      $content .= "<h2>Se connecter en tant que :</h2>\n"
        ...
        .'<label for="simulated_uid">Identifiant de l\'utilisateur à simuler : </label>'
        .'<input name="simulated_uid" id="simulated_uid" />'
        .'<input type="submit" value="Simuler ce profil" />'
        .'</form>';
    }
