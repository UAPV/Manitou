...
class authenticationActions extends sfActions
{
  public function executeLogin (sfWebRequest $request)
  {
    ...
    if($request->isMethod('post'))
    {
      ...
      if ($this->form->isValid())
      {
        ...
        {
          $this->getContext()->set('ldap', $ldap = new uapvLdap()) ;
  ...
  public function executeCasLogin (sfWebRequest $request)
  {
    // Being here means that the user has already been authenticated by our security filter
  ...
  public function executeLogout (sfWebRequest $request) 
  {
    ...
    if(sfConfig::get ('app_cas_server_host'))
    {
      ...
      $logoutUrl = sfConfig::get ('app_cas_logout_redirect_url', $this->getContext ()
                                                                      ->getController ()
                                                                      ->genUrl ('@homepage', true));
      phpCAS::logoutWithRedirectService ($request->getParameter ('redirect', $logoutUrl));
    }
